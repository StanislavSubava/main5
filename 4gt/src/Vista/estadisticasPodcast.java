...
public class estadisticasPodcast extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					estadisticasPodcast frame = new estadisticasPodcast();
	...
	/**
	 * Se genera en esta ventana los podcast puediendo ordenarlas por semana, mes,
	 * año
	 */
	public estadisticasPodcast() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 706, 626);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setTitle("Ventana estadisticas Podcast");
		...
		/*		String sql = "SELECT r.IDCliente, r.IDAudio, a.Nombre, r.FechaReproduccion, r.VecesReproducida, a.Tipo "
						...
						+ "WHERE a.Tipo = 'Podcast' " + "ORDER BY WEEK(r.FechaReproduccion);";
		*/
				String sql ="SELECT\n"
...
/*
				String sql = "SELECT r.IDCliente, r.IDAudio, a.Nombre, r.FechaReproduccion, r.VecesReproducida, a.Tipo "
						+ "FROM reproducciones r " + "JOIN audios a ON r.IDAudio = a.IDAudio "
						+ "WHERE a.Tipo = 'Podcast' " + "ORDER BY MONTH(r.FechaReproduccion);";
*/
			    String sql	="SELECT\n"
		                + "    c.NombreC AS NombreC,\n"
		                + "    a.NombreA AS NombreA,\n"
...
/*
				String sql = "SELECT r.IDCliente, r.IDAudio, a.Nombre, r.FechaReproduccion, r.VecesReproducida, a.Tipo "
						+ "FROM reproducciones r " + "JOIN audios a ON r.IDAudio = a.IDAudio "
						+ "WHERE a.Tipo = 'Podcast' " + "ORDER BY YEAR(r.FechaReproduccion);";
*/
			String sql	="SELECT\n"
		                + "    c.NombreC AS NombreC,\n"
		                + "    a.NombreA AS NombreA,\n"
